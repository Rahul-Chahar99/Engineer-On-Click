          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                ...
                <h3 className="text-lg leading-6 font-medium text-gray-900">Installation & Configuration</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                ...
                <h3 className="text-lg leading-6 font-medium text-gray-900">Server Room Support</h3>
                <p className="mt-2 text-base text-gray-500">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                ...
                <h3 className="text-lg leading-6 font-medium text-gray-900">Qualified Field Engineers</h3>
                <p className="mt-2 text-base text-gray-500">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                ...
                <h3 className="text-lg leading-6 font-medium text-gray-900">Pan-India Service</h3>
                <p className="mt-2 text-base text-gray-500">
