...
import Clock from "./Clock.jsx"; // Import the new Clock component
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-base-content/70 mt-2">
              Welcome to the Admin Dashboard. Here you can manage engineers,
              customers, and form requests.
            </p>
          </div>
          <Clock />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-base-100 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow border border-base-300">
            ...
            <p className="text-base-content/70 mb-4">
              Manage and view all registered engineers
            </p>
